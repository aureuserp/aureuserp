...
namespace Webkul\Field\Filament\Resources\FieldResource\Schemas;
                        ...
                        Section::make(__('fields::filament/resources/field.form.sections.resource.title'))
                            ->schema([
                                ...
                                Select::make('customizable_type')
                                    ...
                                    ->options(fn (Get $get): array => FieldResource::getCustomizableResourceOptions($get('plugin'))),
                            ]),
                    ])
                    ->columnSpan(['lg' => 1]),
            ])
    ...
    public static function getTypeFormSettings(?string $type): array
    {
        ...
        return match ($type) {
            ...
            'textarea' => [
                ...
                'hintIcon'    => __('fields::filament/resources/field.form.sections.form-settings.settings.textarea.hint-icon'),
            ...
            'file' => [
                ...
                'fileAttachmentsDirectory'         => __('fields::filament/resources/field.form.sections.form-settings.settings.file.file-attachments-directory'),
