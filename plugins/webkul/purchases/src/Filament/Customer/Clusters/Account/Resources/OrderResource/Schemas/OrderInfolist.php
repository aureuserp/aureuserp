...
namespace Webkul\Purchase\Filament\Customer\Clusters\Account\Resources\OrderResource\Schemas;
...
class OrderInfolist
{
    public static function configure(Schema $schema, string $resource): Schema
    {
        return $schema
            ->components([
                Group::make()
                            ...
                            ->schema([
                                ...
                                Group::make()
                                    ...
                                    ->schema([
                                        ...
                                        Livewire::make('chatter-panel', function (Order $record) use ($resource) {
