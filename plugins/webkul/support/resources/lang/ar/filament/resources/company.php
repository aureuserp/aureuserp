        ...
        'actions' => [
            ...
            'delete' => [
                'notification' => [
                    ...
                    'default-company' => [
                        'title' => 'لا يمكن حذف الشركة الافتراضية',
                        'body'  => 'لا يمكنك حذف الشركة المحددة حالياً كشركتك الافتراضية.',
                    ],
                ],
            ],
            ...
            'force-delete' => [
                'notification' => [
                    ...
                    'error' => [
                        'title' => 'فشل الحذف النهائي للشركة',
                        'body'  => 'تعذر حذف الشركة نهائياً لأنها مرتبطة بسجلات أخرى.',
                    ],
                ],
            ],
        ],
        ...
        'bulk-actions' => [
            ...
            'force-delete' => [
                'notification' => [
                    ...
                    'error' => [
                        'title' => 'فشل الحذف النهائي للشركات',
                        'body'  => 'تعذر حذف الشركات نهائياً لأنها مرتبطة بسجلات أخرى.',
                    ],
                ],
            ],
        ],
