                            ...
                            @foreach($partners as $partnerId => $partner)
                                <tbody class="divide-y divide-gray-200 dark:divide-white/5!">
                                    ...
                                    <tr class="bg-gray-50/50 dark:bg-white/5 cursor-pointer hover:bg-gray-100/50 dark:hover:bg-white/5!"
                                        wire:click="togglePartnerLines({{ $partnerId }})">
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <svg class="w-4 h-4 transition-transform @if($this->isPartnerExpanded($partnerId)) rotate-90 @endif" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    {{-- Partner Lines --}}
                                    @if($this->isPartnerExpanded($partnerId))
                                        @foreach($this->getPartnerLines($partnerId) as $line)
