                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-white/5!">
                        ...
                        <thead class="bg-gray-50/50 dark:bg-white/5">
                            <tr>
                                ...
                                <th colspan="2" scope="col" class="border-b border-gray-200 px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider dark:border-white/5! dark:text-gray-400">Initial Balance</th>
                                <th colspan="2" scope="col" class="border-b border-gray-200 px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider dark:border-white/5! dark:text-gray-400">{{ \Carbon\Carbon::parse($data['date_from'])->format('M Y') }}</th>
                                <th colspan="2" scope="col" class="border-b border-gray-200 px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider dark:border-white/5! dark:text-gray-400">End Balance</th>
                            </tr>
